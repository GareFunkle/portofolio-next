...
const SectionAbout = () => {
  return (
    ...
    >
      <div className='  box-border  h-auto w-2/3   rounded-xl border  border-white bg-card-gradient p-12 transition-all duration-300 hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] '>
