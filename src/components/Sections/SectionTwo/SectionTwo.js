...
const SectionTwo = () => {
  return (
    <div id='a-propos' className='mt-12 h-screen w-full '>
      <div className=' relative left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center'>
        <div className='relative box-border flex w-2/3 rounded-xl border border-white bg-card-gradient p-12  '>
          <div className='flex w-64 flex-1 flex-col  text-white'>
            ...
            <p className='mb-4 text-p'>
              ...
              marketing, développant ainsi mes compétences. Je me considère
              comme un professionnel polyvalent, capable de m'adapter à diverses
